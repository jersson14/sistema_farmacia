...
<div class="box-header with-border">
  <h1 class="box-title">Ingresos <button class="btn btn-success" id="btnagregar" onclick="mostrarform(true, true)"><i class="fa fa-plus-circle"></i>Agregar</button></h1>
...
require 'footer.php';
 ?>
 <script src="scripts/ingreso.js?v=20260529a"></script>
 <?php 
}
